  ...
  return (
    <div className="login-page">
      <div className="login-card">
        {/* Yellow Header - Exact Figma Match */}
        ...
        <div className="login-content">
          ...
          >
            ...
            {isLoading ? 'Signing in...' : 'Sign in with Lion Mail'}
          </button>

          {/* Hint Text */}
          <div className="login-hint">
            <p>Use your @Columbia.edu email to sign in.</p>
            <p>Only Columbia University accounts are allowed.</p>
          </div>
        </div>
      </div>
    </div>
